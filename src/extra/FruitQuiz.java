...
JLabel newQuestion;
	void makeQuestions() {
		...
		question2 = new JLabel(
				"<html>Which is not a real fruit? <br> A:Purpleberrry <br> B: Mangosteen C:Starfruit<html>");

		question3 = new JLabel(

				"<html>Which is not a real fruit? <br> A:Rambutan <br> B:Greenberry  C:Longan<html>");
		question4 = new JLabel(

				"<html>Which is not a real fruit? <br> A:Sapodilla <br> B:Persimmon C:Orangeberry<html>");
	}
